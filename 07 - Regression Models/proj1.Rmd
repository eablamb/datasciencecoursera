...
Starting out, it looks like automatic transmission on average delivers superior fuel economy than manual transmission.  However, "common knowledge" states that automatic cars are less fuel efficient than manual cars.  Automatic cars use a torque converter to switch between gears, which can be less efficient than a clutch, especially on older vehicles with fewer gears.

### Car Weight as a Confounder

One thing we need to look at is how weight affects MPG, as well as look into any correlation between weight and transmission inherent in our data.
