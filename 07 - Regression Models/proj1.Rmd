...
Look at the cars in the weight range where automatic and manual transmission overlap (roughly between 2,500 and 3,500 lbs).  Here we notice an opposite trend.  Cars with automatic transmission tend to have better gas milage than ones with manual transmission.
